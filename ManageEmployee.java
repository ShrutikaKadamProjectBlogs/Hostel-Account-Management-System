  ...
  public void tabledetails()
  {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee iid", "Activated", "Designation"
            }
        ));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 390, 30));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, -1, 30));

        jLabel4.setFont(new java.awt.Font("Myanmar Text", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 0, 51));
        jLabel4.setText("Update & Delete Rows");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 110, 30));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 370, 50));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 270, 170, 30));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/mizu.png"))); // NOI18N
        jLabel15.setPreferredSize(new java.awt.Dimension(700, 520));
    ...
    if(empid.equals("")){ JOptionPane.showMessageDialog(null,"EMPLOYEE ID CAN NOT BE EMPTY ");}
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Connection Con=DatabaseConnection.getCon();
            Statement st=Con.createStatement();
             ...
             st.executeUpdate("DELETE FROM emp1 WHERE empid='"+empid+"'");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try{
            Connection Con=DatabaseConnection.getCon();
            Statement st=Con.createStatement();
            ResultSet rs=st.executeQuery("select *from emp1 where empid='"+empid+"'");
            while(rs.next())
            {
               i=1;
               if(rs.getString(3).equals("Working"))
               {
               ...
               if(i==0)
               {
               JOptionPane.showMessageDialog(null,"Employeeid number doesnot exist");
               clear();
        ...
        JOptionPane.showMessageDialog(null, "Employeeid number does not exist.");
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        Connection Con=DatabaseConnection.getCon();
            Statement st=Con.createStatement();
            st.executeUpdate("UPDATE emp1 SET activate='"+activate+"' WHERE empid="+empid);
